...
const CHART_DEFINITIONS = [
  ...
  // Enrollment
  {
    ...
    description: "Enrollment split across EE Only / EE+Spouse / EE+Child(ren) / Family for medical.",
    category: "enrollment",
    sortOrder: 200,
  },
  {
    ...
    description: "Enrollment split across EE Only / EE+Spouse / EE+Child(ren) / Family for dental.",
    category: "enrollment",
    sortOrder: 210,
  },
  {
    ...
    description: "Enrollment split across EE Only / EE+Spouse / EE+Child(ren) / Family for vision.",
    category: "enrollment",
    sortOrder: 220,
  },
  {
